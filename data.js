...
window.BATTLE_DATA = (function () {
  ...
  const units = [
    ...
    { id:"firstaid", name_zh:"急救站", name_en:"First-aid station", faction:"jp",
      track:[ {d:12,lng:114.1804,lat:22.3047,s:60,st:"hold"}, {d:25,lng:114.1804,lat:22.3047,s:30,st:"hold"} ] },
    { id:"reporters", name_zh:"記者", name_en:"Reporters", faction:"jp",
      track:[ {d:12,lng:114.1790,lat:22.3038,s:50,st:"hold"}, {d:25,lng:114.1790,lat:22.3038,s:20,st:"hold"} ] },
  ...
  const storyboard = [
    ...
    { day:11.5, hold:9, cam:{lng:114.1793,lat:22.3025,dist:700,az:20,el:52,orbit:0.6},
      ...
      focus:["inside_main"], side:"jp" },
    { day:17, hold:9.5, cam:{lng:114.1798,lat:22.3038,dist:620,az:30,el:58,orbit:0.6},
    ...
    { day:17.3, hold:9.5, cam:{lng:114.1789,lat:22.3030,dist:560,az:14,el:60,orbit:0.5},
    ...
    { day:17.8, hold:9, cam:{lng:114.1800,lat:22.3040,dist:680,az:36,el:55,orbit:0.6},
    ...
    { day:18, hold:9, cam:{lng:114.1808,lat:22.3035,dist:600,az:50,el:56,orbit:0.6},
    ...
    { day:18.5, hold:9.5, cam:{lng:114.1786,lat:22.3024,dist:520,az:8,el:62,orbit:0.5},
    ...
    { day:20, hold:9, cam:{lng:114.1799,lat:22.3041,dist:620,az:24,el:55,orbit:0.6},
    ...
    { day:22, hold:9, cam:{lng:114.1803,lat:22.3038,dist:640,az:18,el:54,orbit:0.6},
    ...
    { day:29, hold:10, cam:{lng:114.180,lat:22.3032,dist:880,az:6,el:48,orbit:0.6},
