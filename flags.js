...
export function flagTexture(unit){
  // PolyU 2019 · de-militarised: NO national/service flags. Return null so
  // entities.buildUnit skips the flag mesh and a unit shows only its neutral
  // side-coloured marker + name label. The painters above are kept intact but
  // unused, so the engine diff stays minimal.
  return null;
