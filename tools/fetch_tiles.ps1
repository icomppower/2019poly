...
# PolyU / Hung Hom. AWS Terrarium DEM maxzoom is 15 and the engine uses one zoom
# for DEM + imagery, so z is capped at 15. (Node-only? use tools/fetch_tiles.mjs.)
$minLng = 114.173; $maxLng = 114.187; $minLat = 22.298; $maxLat = 22.309; $z = 15
